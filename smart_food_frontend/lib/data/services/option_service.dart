...
class OptionService {
  static const String baseUrl = "http://10.0.2.2:8000/api/products/options";

  static Future<List<OptionModel>> fetchOptions() async {
  ...
  static Future<OptionModel?> fetchOption(int id) async {
    final res = await ApiClient.send((token) {
      return http.get(
    ...
    if (res.statusCode == 200) {
      final decoded = utf8.decode(res.bodyBytes);
      return OptionModel.fromJson(jsonDecode(decoded));
    }
    return null;
  }
