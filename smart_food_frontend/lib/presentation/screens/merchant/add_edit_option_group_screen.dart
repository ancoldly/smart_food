...
class AddEditOptionGroupScreen extends StatefulWidget {
  final ProductModel product;
  final OptionGroupModel? group;
  const AddEditOptionGroupScreen({super.key, required this.product, this.group});

  @override
  State<AddEditOptionGroupScreen> createState() => _AddEditOptionGroupScreenState();
}

class _AddEditOptionGroupScreenState extends State<AddEditOptionGroupScreen> {
  ...
  Future<void> _submit() async {
    ...
    final provider = Provider.of<OptionGroupProvider>(context, listen: false);
    bool ok;
    if (widget.group == null) {
  ...
  Widget build(BuildContext context) {
    ...
    final title = widget.group == null ? "Thêm nhóm tùy chọn" : "Sửa nhóm tùy chọn";
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _inputField("Tên nhóm *", "Ví dụ: Đá, Đường", nameCtrl),
