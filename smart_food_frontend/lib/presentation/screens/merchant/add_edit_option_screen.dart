...
class AddEditOptionScreen extends StatefulWidget {
  final OptionGroupModel group;
  final OptionModel? option;
  const AddEditOptionScreen({super.key, required this.group, this.option});

  @override
  State<AddEditOptionScreen> createState() => _AddEditOptionScreenState();
}

class _AddEditOptionScreenState extends State<AddEditOptionScreen> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _inputField("Tên lựa chọn *", "Ví dụ: Đường 50%", nameCtrl),
            const SizedBox(height: 14),
            _inputField("Giá", "0", priceCtrl,
